...
class IntervalProductionRepository(IntervalProductionRepositoryInterface):
    ...
    def get_by_date_and_turno(self, fecha: str, turno: str) -> List[IntervalProduction]:
        """
        Obtiene los registros de IntervalProduction para la fecha indicada.
        El filtrado por turno debe realizarse a nivel de aplicación, usando el campo unixtime.
        """
